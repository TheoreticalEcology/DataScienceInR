...
**Please carefully follow the instructions for setting up your working environment in [Getting started with R](https://theoreticalecology.github.io/DataScienceInR/0-GettingStarted.html).**
...
this_letter = "A" # characters/strings always between quotes
print(this_letter)
```
...
```{r}
my.mat <- cbind(age, names)
my.mat
my.mat[1,] # first row, all columns
```
