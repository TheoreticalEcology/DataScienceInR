...
The `data.frame` `dat` contains 4 columns: species, dbh (diameter at breast height \[cm\]), height \[m\] and rem, a remark.
...
For this exercise, use the dplyr package to calculate mean dbh per species. 
If you need help on this, check the demonstration of Part 2 where we calculated summary statistics for groups using the dplyr package!
