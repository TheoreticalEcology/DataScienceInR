...
Poisson regression is used for count data. Properties of count data are: no negative values,
only integers, y \~ Poisson(lambda); where lambda = mean = variance, log link function (lambda must be positive).
