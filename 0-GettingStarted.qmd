...
-   R is the calculation engine (language and environmet) that performs the computations. You can download the latest R version [here](https://cran.r-project.org/).
