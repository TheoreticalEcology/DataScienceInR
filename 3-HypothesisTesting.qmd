...
What's happening here? We have no effect in our simulation but there are many p-values lower than $\alpha = 0.5$:
...
1-type II error rate is the so called statistical power. We want a high power because it reduces the rate of type II errors.
