...
::: column-margin
why do whe use `set.seed()` here?
Read the help file of the function to understand it! `help(set.seed)`. Experiment changing the number in the set seed in your code and compare the results for tne number of cured patients in the treatment and control groups.
:::
