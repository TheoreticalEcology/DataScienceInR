...
The focus on the NMDS is in the observations - the difstance between observations given their properties (the variables).
...
For the NMDS the stress information should be low:

-   **stress of \>= 0.2**, be suspicious,

-   **stress \>= 0.3** indicates that ordination is arbitrary
